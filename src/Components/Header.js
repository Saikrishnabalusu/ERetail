  ...
  return (
    <div className="flex items-center gap-2">
      <img
        src={icon}
        alt={`${text} icon`}
        className="w-8 h-8 rounded-full mix-blend-multiply object-contain"
      />
...
const Header = () => {
  ...
  return (
    <div className="w-full h-20 flex justify-between items-center  gap-4 bg-white shadow-md select-none sticky top-0">
      <div className="ml-4 flex items-center gap-8">
        <img
          src={logo}
          className="w-40 h-auto mix-blend-multiply object-contain"
          alt="FOW Logo"
        />
        <input
          type="text"
